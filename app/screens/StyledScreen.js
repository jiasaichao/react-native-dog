...
export default class StyledScreen extends Component {
  ...
  static navigatorButtons = {
    rightButtons: [{
      icon: require('../assets/img/navicon_edit.png'),
      id: 'compose',
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        <Image style={{width: undefined, height: 100}} source={require('../assets/img/colors.png')} />
  ...
  onSetTitleImagePress() {
    this.props.navigator.setTitle({
      title: 'title',
      titleImage: require('../assets/img/one.png'),
    })
  }
